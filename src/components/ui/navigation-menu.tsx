    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          ...
          "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] " +
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        ...
        "focus:text-accent-foreground focus-visible:ring-ring/50 [&_svg:not([class*='text-'])]:text-muted-foreground " +
        "flex flex-col gap-1 rounded-sm p-2 text-sm transition-all outline-none focus-visible:ring-[3px] " +
