...
export function TalentOnboardingForm({ skills }: TalentOnboardingFormProps) {
  ...
  // We use the "adjust state during render" pattern to avoid useEffect
          ...
          <form id="onboarding-form" action={action} className="space-y-6">
                      ...
                      return (
                        <div key={field} className="flex items-center justify-between gap-4 group">
                          <div className="space-y-0.5">
                            ...
                            <span className="ml-1 text-muted-foreground">{messages?.[0]}</span>
                          </div>
            ...
            <div className={currentStep === 1 ? 'block space-y-4' : 'hidden'}>
              <div className="space-y-2">
                ...
                <Input id="fullName" name="fullName" placeholder="John Doe" onChange={() => clearError('fullName')} />
            ...
            <div className={currentStep === 2 ? 'block space-y-4' : 'hidden'}>
              ...
              <div className="space-y-2">
                ...
                {localErrors?.totalExperienceYears && (
                  <p className="text-sm text-red-500">{localErrors.totalExperienceYears}</p>
                )}
              </div>
              ...
              <div className="flex items-center space-x-2">
                <Input
                  ...
                  className="h-4 w-4"
                />
                <Label htmlFor="isFresher" className="text-sm font-normal">
                  I am a fresher / looking for first job
                </Label>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    ...
                    {manualSkills.map((skill) => (
                      <div
                        key={skill}
                        className="bg-secondary text-secondary-foreground px-2 py-1 rounded-md text-sm flex items-center gap-1 border"
                      >
                        {skill}
                        <button
                          type="button"
                  ...
                  <div className="border rounded-md max-h-32 overflow-y-auto p-2 space-y-1">
                    {skills
                      ...
                      .map((skill) => (
                        <div
                          key={skill.id}
                          className={`px-2 py-1.5 text-sm rounded cursor-pointer flex justify-between 
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    If you can&apos;t find a skill in the library, add it here.
                  </p>
                </div>
            ...
            <div className={currentStep === 4 ? 'block space-y-4' : 'hidden'}>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="url"
                  onChange={() => clearError('linkedinUrl')}
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="url"
                  onChange={() => clearError('portfolioUrl')}
                />
              ...
              {additionalLinks.length < 2 && (
                <Button
                  ...
                  size="sm"
                  onClick={addLink}
                  className="mt-2 w-full cursor-pointer border-dashed"
                >
                  + Add Another Link
                </Button>
              )}
