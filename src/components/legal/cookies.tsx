  ...
  return (
    <div className="container mx-auto py-10 max-w-4xl space-y-8">
      ...
      <div className="space-y-4">
        ...
        <TypographyP>
          Type: Session Cookies. Administered by: Us. Purpose: These Cookies are essential to provide You with services
          available through the Website and to enable You to use some of its features. They help to authenticate users
          and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for
        ...
        <TypographyP>
          ...
          when You use the Website, such as remembering your login details or language preference. The purpose of these
          Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences
      ...
      <div className="space-y-4">
        ...
        <TypographyP>If you have any questions about this Cookie Policy, You can contact us:</TypographyP>
