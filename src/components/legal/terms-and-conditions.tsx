  ...
  return (
    <div className="container mx-auto py-10 max-w-4xl space-y-8">
      <div className="space-y-4">
        ...
        <TypographyP>Please read these terms and conditions carefully before using Our Service.</TypographyP>
      </div>
      ...
      <div className="space-y-4">
        ...
        <TypographyP>Upon termination, Your right to use the Service will cease immediately.</TypographyP>
      </div>
