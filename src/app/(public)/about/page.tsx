        ...
        <div className="container px-4 text-center max-w-4xl mx-auto space-y-8">
           <div
             className={
               ...
               "focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-primary text-primary-foreground hover:bg-primary/80 mb-4"
             }
           >
             Our Mission
           </div>
          ...
          <TypographyLead>
            We believe ability matters more than a resume. We&apos;re building a
            world where developers get hired for what they can do, not who they
            know.
          </TypographyLead>
        </div>
      </section>
             ...
             <div className="grid md:grid-cols-2 gap-12 items-center">
                 <div className="space-y-6">
                     ...
                     <p className="text-lg text-muted-foreground">
                         The traditional hiring process is broken. Resume screens
                         filter out great talent, and whiteboard interviews test
                         memorization, not engineering skills.
                     </p>
                     <p className="text-lg text-muted-foreground">
                         We started TrustLayer to create a meritocratic platform.
                         Developers prove their skills through real-world projects,
                         and companies get access to pre-vetted talent without the
                         headache of screening hundreds of unqualified candidates.
                     </p>
                 </div>
      ...
      <section className="py-24 bg-muted/30">
        <div className="container px-4 text-center">
             ...
             <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto justify-center">
                 ...
                 <Card className="p-6">
                     <div
                       className= "w-24 h-24 rounded-full bg-blue-100 mx-auto mb-4 flex items-center justify-center"
                     >
       ...
       <section className="py-24 border-t">
           <div className="container px-4 text-center">
                <div
                  className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary/10 mb-6 text-primary"
                >
