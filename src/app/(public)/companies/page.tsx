...
import { TypographyH1, TypographyH2, TypographyH3, TypographyH4, TypographyLead, TypographyMuted } from "@/components/ui/typography";
       ...
       <section className="bg-gradient-to-b from-purple-50/50 to-background dark:from-purple-950/20 py-20 md:py-32 border-b">
        <div className="container px-4 text-center max-w-4xl mx-auto space-y-6">
          ...
          <TypographyLead className="max-w-2xl mx-auto">
            We've already done the hard work. Access a pool of developers who have passed rigorous technical and communication assessments.
          </TypographyLead>
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
            <Button size="lg" className="rounded-full h-12 px-8 text-base" style={{ backgroundColor: 'var(--color-tertiary)', color: 'white' }}>
        ...
        <div className="container px-4">
             <div className="grid md:grid-cols-3 gap-12">
                <div className="space-y-4">
                     ...
                     <TypographyMuted>Reduce time-to-hire from months to days. Our developers are ready to start immediately.</TypographyMuted>
                </div>
                 <div className="space-y-4">
                     <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center text-primary mb-4">
                     ...
                     <TypographyMuted>We check code quality, architecture patterns, and communication skills so you don't have to.</TypographyMuted>
                </div>
                 <div className="space-y-4">
                     <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center text-primary mb-4">
                     ...
                     <TypographyMuted>Pay nothing unless you hire. We offer a satisfaction guarantee on all placements.</TypographyMuted>
                </div>
             </div>
        </div>
      </section>
                 ...
                 <div className="space-y-8">
                     <div className="flex gap-4">
                         ...
                         <div>
                             ...
                             <TypographyMuted className="text-sm">Verification of identity, basic coding knowledge, and English proficiency.</TypographyMuted>
                         </div>
                     </div>
                     <div className="flex gap-4">
                          <div className="flex-none mt-1">
                         ...
                         <div>
                             ...
                             <TypographyMuted className="text-sm">They build a complex, real-world feature (e.g., Auth, Payments) with clean, documented code.</TypographyMuted>
                         </div>
                     </div>
                     <div className="flex gap-4">
                          <div className="flex-none mt-1">
                         ...
                         <div>
                             ...
                             <TypographyMuted className="text-sm">We review their GitHub repo and a 3-minute video explanation to assess their thought process.</TypographyMuted>
                         </div>
                     </div>
                      <div className="flex gap-4">
                          <div className="flex-none mt-1">
                         ...
                         <div>
                             <TypographyH4 className="text-lg">Final Interview</TypographyH4>
                             <TypographyMuted className="text-sm">A senior engineer from our team conducts a final behavioral and technical interview.</TypographyMuted>
                         </div>
                     </div>
                 </div>
           ...
           <div className="container px-4 text-center">
               <div className="max-w-3xl mx-auto space-y-8">
                   ...
                   <TypographyLead className="text-lg">
                       You only pay <b>10k INR</b> after a successful 3 months with the candidate. If it doesn't work out before then, you owe us nothing.
                   </TypographyLead>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
                        <Button size="lg" className="rounded-full" style={{ backgroundColor: 'var(--color-tertiary)', color: 'white' }}>
